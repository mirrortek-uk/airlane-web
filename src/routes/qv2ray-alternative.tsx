...
const page = LANDING_PAGES["qv2ray-alternative"].zh;

export const Route = createFileRoute("/qv2ray-alternative")({
  head: altLandingHead({
...
function Page() {
  return <AltLandingPage cfg={page.cfg} slug="qv2ray-alternative" />;
}
