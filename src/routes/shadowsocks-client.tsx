...
const page = LANDING_PAGES["shadowsocks-client"].zh;

export const Route = createFileRoute("/shadowsocks-client")({
  head: altLandingHead({
...
function Page() {
  return <AltLandingPage cfg={page.cfg} slug="shadowsocks-client" />;
}
